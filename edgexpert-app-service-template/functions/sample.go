...
// For more details on the Context API got here: https://docs.edgexfoundry.org/2.3/microservices/application/ContextAPI/
func (s *Sample) LogEventDetails(ctx interfaces.AppFunctionContext, data interface{}) (bool, interface{}) {
	...
	if data == nil {
		// Go here for details on Error Handle: https://docs.edgexfoundry.org/2.3/microservices/application/ErrorHandling/
...
func (s *Sample) OutputXML(ctx interfaces.AppFunctionContext, data interface{}) (bool, interface{}) {
	...
	// For more details on the SetResponseData() function go here: https://docs.edgexfoundry.org/2.3/microservices/application/ContextAPI/#complete
