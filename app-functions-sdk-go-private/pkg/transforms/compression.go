...
type Compression struct {
	// note that EdgeXFoundry community removed following writers to avoid data race issue, and Edge Xpert avoid data races
	// using a mutex to ensure atomic writer operation.  Per investigation at https://iotechsys.atlassian.net/browse/EDX-3765,
	// we should keep our own fix rather than merging EdgeXFoundry's fix.
	gzipWriter   *gzip.Writer
	zlibWriter   *zlib.Writer
	mutex        sync.Mutex
	Base64Encode bool // indicates the compressed data should be encoded with base64
}
