...
// AddFunctionsPipelineForTopics provides a mock function with given fields: id, topic, triggerType, useTargetTypeOfByteArray, transforms
func (_m *ApplicationService) AddFunctionsPipelineForTopics(id string, topic []string, triggerType string, useTargetTypeOfByteArray bool, transforms ...func(interfaces.AppFunctionContext, interface{}) (bool, interface{})) error {
	_va := make([]interface{}, len(transforms))
	for _i := range transforms {
		_va[_i] = transforms[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, id, topic, triggerType, useTargetTypeOfByteArray)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, []string, string, bool, ...func(interfaces.AppFunctionContext, interface{}) (bool, interface{})) error); ok {
		r0 = rf(id, topic, triggerType, useTargetTypeOfByteArray, transforms...)
	} else {
		r0 = ret.Error(0)
	}
