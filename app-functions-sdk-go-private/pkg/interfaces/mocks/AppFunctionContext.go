...
import (
	...
	xpert "github.com/edgexfoundry/app-functions-sdk-go/v2/internal/common/xpert"
)
...
// MqttConnectionWaitingCounter provides a mock function with given fields:
func (_m *AppFunctionContext) MqttConnectionWaitingCounter() *xpert.AtomicCounter {
	ret := _m.Called()

	var r0 *xpert.AtomicCounter
	if rf, ok := ret.Get(0).(func() *xpert.AtomicCounter); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*xpert.AtomicCounter)
		}
	}
...
// SetMqttConnectionWaitingCounter provides a mock function with given fields: _a0
func (_m *AppFunctionContext) SetMqttConnectionWaitingCounter(_a0 *xpert.AtomicCounter) {
	_m.Called(_a0)
}
...
// SetSharedMQTTClient provides a mock function with given fields: client
func (_m *AppFunctionContext) SetSharedMQTTClient(client *xpert.SharedMQTTClient) {
	_m.Called(client)
}

// SetSharedMQTTClientMutex provides a mock function with given fields: mutex
func (_m *AppFunctionContext) SetSharedMQTTClientMutex(mutex *sync.Mutex) {
	_m.Called(mutex)
}

// SharedMQTTClient provides a mock function with given fields:
func (_m *AppFunctionContext) SharedMQTTClient() *xpert.SharedMQTTClient {
	ret := _m.Called()

	var r0 *xpert.SharedMQTTClient
	if rf, ok := ret.Get(0).(func() *xpert.SharedMQTTClient); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*xpert.SharedMQTTClient)
		}
	}
...
// SharedMQTTClientMutex provides a mock function with given fields:
func (_m *AppFunctionContext) SharedMQTTClientMutex() *sync.Mutex {
	ret := _m.Called()
...
// XpertGetDevice provides a mock function with given fields: deviceName
func (_m *AppFunctionContext) XpertGetDevice(deviceName string) (dtos.Device, errors.EdgeX) {
...
// XpertGetDeviceResource provides a mock function with given fields: profileName, resourceName
func (_m *AppFunctionContext) XpertGetDeviceResource(profileName string, resourceName string) (dtos.DeviceResource, errors.EdgeX) {
	ret := _m.Called(profileName, resourceName)
...
// NewAppFunctionContext creates a new instance of AppFunctionContext. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAppFunctionContext(t testing.TB) *AppFunctionContext {
