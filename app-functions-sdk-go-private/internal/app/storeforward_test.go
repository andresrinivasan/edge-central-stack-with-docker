...
var testTlsConfig = &tls.Config{MinVersion: tls.VersionTLS12}
...
func Test_service_NewStoreClient_Invalid(t *testing.T) {
	...
	_, err := sut.createStoreClient(interfaces.DatabaseInfo{}, config.Credentials{}, testTlsConfig)
...
func Test_service_NewStoreClient_Redis(t *testing.T) {
	...
	result, err := sut.createStoreClient(interfaces.DatabaseInfo{Type: db.RedisDB, Timeout: "5s"}, config.Credentials{}, testTlsConfig)
...
func Test_service_NewStoreClient_Custom(t *testing.T) {
	...
	result, err := sut.createStoreClient(interfaces.DatabaseInfo{Type: name}, config.Credentials{}, testTlsConfig)
