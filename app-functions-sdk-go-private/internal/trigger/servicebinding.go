...
type ServiceBinding interface {
	...
	DecodeMessage(appContext *appfunction.Context, envelope types.MessageEnvelope, pipelineId string) (interface{}, *runtime.MessageError, bool)
	...
	GetMatchingPipelines(incomingTopic string, triggerType string) []*interfaces.FunctionPipeline
