...
var TestValidNoAuthConfig = interfaces.DatabaseInfo{
	Type:      db.RedisDB,
	Host:      TestHost,
	Port:      TestPort,
	Timeout:   TestTimeout,
...
func TestClient_NewClient(t *testing.T) {
	tests := []struct {
		name          string
		config        interfaces.DatabaseInfo
		expectedError bool
	}{
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			_, err := NewClient(test.config, bootstrapConfig.Credentials{}, testTlsConfig)
...
func TestClient_Store(t *testing.T) {
	...
	client, _ := NewClient(TestValidNoAuthConfig, bootstrapConfig.Credentials{}, testTlsConfig)
