...
func (appContext *Context) Clone() interfaces.AppFunctionContext {
	...
	return &Context{
		...
		XpertContext: XpertContext{
			sharedMQTTClient:             appContext.sharedMQTTClient,
			sharedMQTTClientMutex:        appContext.sharedMQTTClientMutex,
			mqttConnectionWaitingCounter: appContext.mqttConnectionWaitingCounter,
		},
	}
}
